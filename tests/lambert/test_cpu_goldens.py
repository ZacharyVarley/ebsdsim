...
from ebsdsim.engine.integrate import compute_mu_eff, trim_multi_voltage_mc_by_coverage
from ebsdsim.lambert.kgrid import build_pg_k_grid
from ebsdsim.lambert.rasterize import RasterizeOptions, rasterize_pattern
from ebsdsim.testing import compare_float32_golden
...
def test_kgrid_rasterize_golden_case0():
    ...
    for case in data["cases"]:
        ...
        pg_grid = build_pg_k_grid(
            int(grid_info["pg_num"]),
            int(grid_info["hw"]),
            # Orientation-unambiguous PGs in the golden set; any matching SG works.
            space_group={2: 3, 11: 83, 23: 177, 32: 221}[int(grid_info["pg_num"])],
        )
